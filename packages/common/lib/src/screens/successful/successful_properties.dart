...
@immutable
class KISuccessfulProperties extends ThemeExtension<KISuccessfulProperties>
  ...
  @override
  KISuccessfulProperties copyWith({
  ...
  @override
  KISuccessfulProperties lerp(
      ThemeExtension<KISuccessfulProperties>? other, double t) {
    if (other is! KISuccessfulProperties) return this;
